...
public class ChaosConfig implements WebMvcConfigurer {
    ...
    public static class ChaosInterceptor implements HandlerInterceptor {
        ...
        private static final String[] ERROR_MESSAGES = {
                "Docking clamp malfunction detected",
                "Bay pressure equalization failure",
                "Magnetic lock system error",
                "Approach guidance sensor offline",
                "Umbilical connection fault",
                "Docking seal integrity warning",
