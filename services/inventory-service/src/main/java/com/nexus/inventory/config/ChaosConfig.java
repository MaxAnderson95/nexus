...
public class ChaosConfig implements WebMvcConfigurer {
    ...
    public static class ChaosInterceptor implements HandlerInterceptor {
        ...
        private static final String[] ERROR_MESSAGES = {
                "Inventory scanner malfunction",
                "Cargo bay sensor failure",
                "Supply tracking database timeout",
                "RFID reader interference detected",
                "Manifest synchronization error",
                "Storage compartment lock failure",
                "Inventory barcode corrupted"
        };
