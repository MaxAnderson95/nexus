...
import com.nexus.inventory.config.DataInitializer;
...
public class AdminController {
    ...
    public ResponseEntity<Map<String, String>> resetTables() {
        log.info("Admin: Resetting tables for Inventory Service");
        dataInitializer.resetTables();
        return ResponseEntity.ok(Map.of(
            "service", "inventory",
            "status", "success",
            "message", "Inventory Service tables reset successfully"
        ));
    }
}
