...
public class ChaosConfig implements WebMvcConfigurer {
    ...
    public static class ChaosInterceptor implements HandlerInterceptor {
        ...
        private static final String[] ERROR_MESSAGES = {
                "Neural pathway synchronization failure",
                "Cognitive matrix overload",
                "Data aggregation buffer timeout",
                "Service mesh routing error",
                "Cross-system correlation failure",
                "Telemetry aggregation bottleneck",
                "BFF circuit breaker activated"
        };
